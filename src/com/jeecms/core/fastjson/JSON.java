...
import com.jeecms.core.fastjson.parser.deserializer.ParseProcess;
import com.jeecms.core.fastjson.serializer.AfterFilter;
import com.jeecms.core.fastjson.serializer.BeforeFilter;
import com.jeecms.core.fastjson.serializer.JSONSerializer;
import com.jeecms.core.fastjson.serializer.NameFilter;
import com.jeecms.core.fastjson.serializer.PropertyFilter;
import com.jeecms.core.fastjson.serializer.PropertyPreFilter;
import com.jeecms.core.fastjson.serializer.SerializeConfig;
import com.jeecms.core.fastjson.serializer.SerializeFilter;
import com.jeecms.core.fastjson.serializer.SerializeWriter;
import com.jeecms.core.fastjson.serializer.SerializerFeature;
import com.jeecms.core.fastjson.serializer.ValueFilter;
import com.jeecms.core.fastjson.util.FieldInfo;
import com.jeecms.core.fastjson.util.IOUtils;
import com.jeecms.core.fastjson.util.ThreadLocalCache;
...
public abstract class JSON implements JSONStreamAware, JSONAware {
    ...
    static {
        int features = 0;
        features |= com.jeecms.core.fastjson.serializer.SerializerFeature.QuoteFieldNames.getMask();
        features |= com.jeecms.core.fastjson.serializer.SerializerFeature.SkipTransientField.getMask();
        features |= com.jeecms.core.fastjson.serializer.SerializerFeature.WriteEnumUsingToString.getMask();
        features |= com.jeecms.core.fastjson.serializer.SerializerFeature.SortField.getMask();
        // features |=
        // com.jeecms.core.fastjson.serializer.SerializerFeature.WriteSlashAsSpecial.getMask();
    ...
    public static final String toJSONString(Object object, SerializerFeature... features) {
        ...
        try {
            ...
            for (com.jeecms.core.fastjson.serializer.SerializerFeature feature : features) {
